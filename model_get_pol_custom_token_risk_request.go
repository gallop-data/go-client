...
// checks if the GetPolCustomTokenRiskRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPolCustomTokenRiskRequest{}

// GetPolCustomTokenRiskRequest struct for GetPolCustomTokenRiskRequest
type GetPolCustomTokenRiskRequest struct {
...
func NewGetPolCustomTokenRiskRequest(collectionAddress string, tokenId []string, holdingPeriod string) *GetPolCustomTokenRiskRequest {
	this := GetPolCustomTokenRiskRequest{}
...
func (o GetPolCustomTokenRiskRequest) MarshalJSON() ([]byte, error) {
...
func (o GetPolCustomTokenRiskRequest) ToMap() (map[string]interface{}, error) {
...
type NullableGetPolCustomTokenRiskRequest struct {
	value *GetPolCustomTokenRiskRequest
	isSet bool
}

func (v NullableGetPolCustomTokenRiskRequest) Get() *GetPolCustomTokenRiskRequest {
	return v.value
}

func (v *NullableGetPolCustomTokenRiskRequest) Set(val *GetPolCustomTokenRiskRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPolCustomTokenRiskRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPolCustomTokenRiskRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPolCustomTokenRiskRequest(val *GetPolCustomTokenRiskRequest) *NullableGetPolCustomTokenRiskRequest {
	return &NullableGetPolCustomTokenRiskRequest{value: val, isSet: true}
}

func (v NullableGetPolCustomTokenRiskRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPolCustomTokenRiskRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
