...
// checks if the GetEthTokenTransactionsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetEthTokenTransactionsRequest{}

// GetEthTokenTransactionsRequest struct for GetEthTokenTransactionsRequest
type GetEthTokenTransactionsRequest struct {
...
func NewGetEthTokenTransactionsRequest(collectionAddress string, tokenId string) *GetEthTokenTransactionsRequest {
	this := GetEthTokenTransactionsRequest{}
...
func (o GetEthTokenTransactionsRequest) MarshalJSON() ([]byte, error) {
...
func (o GetEthTokenTransactionsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableGetEthTokenTransactionsRequest struct {
	value *GetEthTokenTransactionsRequest
	isSet bool
}

func (v NullableGetEthTokenTransactionsRequest) Get() *GetEthTokenTransactionsRequest {
	return v.value
}

func (v *NullableGetEthTokenTransactionsRequest) Set(val *GetEthTokenTransactionsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetEthTokenTransactionsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetEthTokenTransactionsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetEthTokenTransactionsRequest(val *GetEthTokenTransactionsRequest) *NullableGetEthTokenTransactionsRequest {
	return &NullableGetEthTokenTransactionsRequest{value: val, isSet: true}
}

func (v NullableGetEthTokenTransactionsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetEthTokenTransactionsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
