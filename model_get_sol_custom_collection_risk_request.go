...
// checks if the GetSolCustomCollectionRiskRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSolCustomCollectionRiskRequest{}

// GetSolCustomCollectionRiskRequest struct for GetSolCustomCollectionRiskRequest
type GetSolCustomCollectionRiskRequest struct {
...
func NewGetSolCustomCollectionRiskRequest(collectionTag string, holdingPeriod string) *GetSolCustomCollectionRiskRequest {
	this := GetSolCustomCollectionRiskRequest{}
...
func (o GetSolCustomCollectionRiskRequest) MarshalJSON() ([]byte, error) {
...
func (o GetSolCustomCollectionRiskRequest) ToMap() (map[string]interface{}, error) {
...
type NullableGetSolCustomCollectionRiskRequest struct {
	value *GetSolCustomCollectionRiskRequest
	isSet bool
}

func (v NullableGetSolCustomCollectionRiskRequest) Get() *GetSolCustomCollectionRiskRequest {
	return v.value
}

func (v *NullableGetSolCustomCollectionRiskRequest) Set(val *GetSolCustomCollectionRiskRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSolCustomCollectionRiskRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSolCustomCollectionRiskRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSolCustomCollectionRiskRequest(val *GetSolCustomCollectionRiskRequest) *NullableGetSolCustomCollectionRiskRequest {
	return &NullableGetSolCustomCollectionRiskRequest{value: val, isSet: true}
}

func (v NullableGetSolCustomCollectionRiskRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSolCustomCollectionRiskRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
