...
// checks if the GetEthCustomCollectionRiskRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetEthCustomCollectionRiskRequest{}

// GetEthCustomCollectionRiskRequest struct for GetEthCustomCollectionRiskRequest
type GetEthCustomCollectionRiskRequest struct {
...
func NewGetEthCustomCollectionRiskRequest(collectionAddress string, holdingPeriod string) *GetEthCustomCollectionRiskRequest {
	this := GetEthCustomCollectionRiskRequest{}
...
func (o GetEthCustomCollectionRiskRequest) MarshalJSON() ([]byte, error) {
...
func (o GetEthCustomCollectionRiskRequest) ToMap() (map[string]interface{}, error) {
...
type NullableGetEthCustomCollectionRiskRequest struct {
	value *GetEthCustomCollectionRiskRequest
	isSet bool
}

func (v NullableGetEthCustomCollectionRiskRequest) Get() *GetEthCustomCollectionRiskRequest {
	return v.value
}

func (v *NullableGetEthCustomCollectionRiskRequest) Set(val *GetEthCustomCollectionRiskRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetEthCustomCollectionRiskRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetEthCustomCollectionRiskRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetEthCustomCollectionRiskRequest(val *GetEthCustomCollectionRiskRequest) *NullableGetEthCustomCollectionRiskRequest {
	return &NullableGetEthCustomCollectionRiskRequest{value: val, isSet: true}
}

func (v NullableGetEthCustomCollectionRiskRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetEthCustomCollectionRiskRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
